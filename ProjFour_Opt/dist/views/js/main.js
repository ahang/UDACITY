...
var resizePizzas = function(size) {
    ...
    // Revised the value since the function gets called only once each time the slider is changed. 
    ...
    // Moved dx and newWidth out of the loop since it is only a constant number. 
...
// Set a variable pScroll outside of loop since it was a constant value. . 
// Set a loop for calculation of phase array and set a loop to calculate the items. 
function updatePositions() {
	...
	var phase = [];
	var pScroll = document.body.scrollTop;
	
	for (var i = 0; i < 5; i++) {
		phase.push(Math.sin(pScroll / 1250 + i) * 100);
	}
...
document.addEventListener('DOMContentLoaded', function() {
	...
	// Set the background pizza to pNumber to reduce 
	// the amount of pizzas being displayed. 200 was way to much.  
	var pNumber = window.innerHeight / 25;
